...
@Component({
  selector: 'app-view-applicationlist',
  templateUrl: './view-applicationlist.component.html',
  styleUrls: ['./view-applicationlist.component.css'],
})
export class ViewApplicationlistComponent implements OnInit {
  ...
  viewApplicationDetails(applicationId: string): void {
    this.router.navigate(['/viewapplication', applicationId]);
  }
